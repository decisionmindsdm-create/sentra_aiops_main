...
export const IncidentsReport: React.FC<IncidentsReportProps> = ({
  ...
  function renderMainReasons(): ReactElement {
    return (
  ...
  function renderAffectedServices(): ReactElement {
    return (
  ...
  function renderRecurringIncidents(): ReactElement {
    return (
  ...
  function renderTimeMetrics(): ReactElement {
    return (
