...
function RangeInputWithLabel({
  ...
  return (
    <div className="flex flex-col gap-1 items-end">
      ...
      <input
        type="range"
        className="bg-[#0d88c0] accent-[#0d88c0] [&::-webkit-slider-runnable-track]:bg-gray-100 [&::-webkit-slider-runnable-track]:rounded-full"
                  ...
                  <div>
                    ...
                    <p className="pt-2">
                      <a
                        ...
                        className="text-[#0d88c0] underline"
                      >
                        ...
                        >
                          {setting.type === "bool" ? (
                            <input
                              ...
                              className="mt-2 bg-[#0d88c0] accent-blue-200"
                            />
                          ) : null}
                          <div>
                    ...
                    {algorithm_config.settings_proposed_by_algorithm &&
                      JSON.stringify(algorithm_config.settings) !==
                        ...
                        <Card className="m-2 mt-4 p-2">
                          ...
                          <button
                            className="mt-2 p-2 bg-[#0d88c0] text-white rounded"
                            onClick={() => {
